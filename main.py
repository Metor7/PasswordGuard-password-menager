...
customtkinter.set_default_color_theme(r"assets\themes\red-theme.json")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        UpdatesMenager._get_latest_version(version_file='https://raw.githubusercontent.com/Metor7/PasswordGuard-password-menager/main/PasswordGuard-password-menager/VERSION', console=self.console)
